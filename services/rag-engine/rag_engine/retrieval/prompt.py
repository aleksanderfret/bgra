...
SYSTEM_PROMPT_TEMPLATE = (
    ...
    "may be stated only when the passages give them.\n"
    "\n"
    ...
    "from your own knowledge of board games, other titles, or what is "
    "'typical', and say it as a fact about the rules, not about the passages "
    "you were given.\n"
    "\n"
